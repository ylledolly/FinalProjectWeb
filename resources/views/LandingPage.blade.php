...
<html data-bs-theme="light" lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-md bg-body" style="height: 70px">
      <div class="container">
        <a class="navbar-brand" href="#">LITSCOPE</a
        ><button
        ...
        <div class="carousel slide" data-bs-ride="false" id="carousel-2">
          ...
          <div>
            <!-- Start: Previous --><a
              ...
              role="button"
              data-bs-slide="prev"
              style="transform: translateX(-206px)"
              ><i
              ...
              ><span
                ...
                style="border-style: solid; border-color: rgb(125, 49, 49)"
                >Previous</span
              ></a
            ><!-- End: Previous --><!-- Start: Next --><a
              class="carousel-control-next"
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="row">
              <div class="col">
                <div class="card" style="margin-top: 22px; height: 258.984px">
          ...
          <!-- Start: categories -->
          <div class="col-lg-3 col-xxl-3" style="height: 566.797px">
            <div class="row">
              <div class="col">
                <div
                  class="card"
                  style="background: rgb(235, 235, 235); margin-top: 24px"
                >
                  <div class="card-body">
                    ...
                    >
                      ...
                      >
                        <span style="background: rgb(235, 235, 235)"
                          >Fourth Wing</span
                        >
                      </li>
                      <li
                      ...
                      >
                        <span style="background: rgb(235, 235, 235)"
                          >All the Colors of the Dark</span
                        >
                      </li>
                    </ol>
                  </div>
                        ...
                        <div class="col">
                          <div class="card d-xxl-flex">
                            <div class="card-body d-xxl-flex">
                              <div>
                                <img
                                  class="rounded-circle me-3 fit-cover"
                                  width="100"
                                  height="100"
                                  src="assets/img/7539785.jpg"
                                />
                                <h4>Name</h4>
                                <p>
    ...
    <div class="container py-4 py-xl-5">
      <div
        ...
        style="
          background: linear-gradient(#cc5500 0%, #cc5500),
            var(--bs-secondary-bg);
        "
      >
    ...
    <!-- End: Stats Color --><!-- Start: Footer Multi Column -->
    <footer>
